...
const (
	Calculate_Add_FullMethodName = "/Calculate/add"
)
...
const (
	Greeter_HelloNamaste_FullMethodName = "/Greeter/helloNamaste"
	Greeter_GoodBye_FullMethodName      = "/Greeter/goodBye"
)
...
type GreeterClient interface {
	HelloNamaste(ctx context.Context, in *GreeterRequest, opts ...grpc.CallOption) (*GreeterResponse, error)
...
func (c *greeterClient) HelloNamaste(ctx context.Context, in *GreeterRequest, opts ...grpc.CallOption) (*GreeterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreeterResponse)
	err := c.cc.Invoke(ctx, Greeter_HelloNamaste_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) GoodBye(ctx context.Context, in *GoodbyeRequest, opts ...grpc.CallOption) (*GoodbyeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Greeter_GoodBye_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	HelloNamaste(context.Context, *GreeterRequest) (*GreeterResponse, error)
...
func (UnimplementedGreeterServer) HelloNamaste(context.Context, *GreeterRequest) (*GreeterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HelloNamaste not implemented")
}
...
func _Greeter_HelloNamaste_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreeterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).HelloNamaste(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_HelloNamaste_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).HelloNamaste(ctx, req.(*GreeterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_GoodBye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_GoodBye_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "helloNamaste",
			Handler:    _Greeter_HelloNamaste_Handler,
		},
		{
			MethodName: "goodBye",
